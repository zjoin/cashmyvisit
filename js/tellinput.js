    ...
    a(b).load(function() {
        ...
        _f: function() {
            ...
            this.h = a("<div>", {
                ...
                "class": "arrow"
            }).appendTo(c), this.isMobile ? this.i = a("<select>").appendTo(b) : (this.i = a("<ul>", {
                "class": "country-list v-hide"
            }).appendTo(b), this.n.length && !this.isMobile && (this._g(this.n, "preferred"), a("<li>", {
                "class": "divider"
        ...
        _loadAutoCountry: function() {
            ...
            if (b && (a.fn[f].autoCountry = b), a.fn[f].autoCountry) this.autoCountryLoaded();
            else if (!a.fn[f].startedLoadingAutoCountry) {
                a.fn[f].startedLoadingAutoCountry = !0;
                var c = "//ipinfo.io";
                this.b.i && (c += "?token=" + this.b.i), a.get(c, function() {}, "jsonp").always(function(b) {
                    a.fn[f].autoCountry = b && b.country ? b.country.toLowerCase() : "", a.cookie && a.cookie("itiAutoCountry", a.fn[f].autoCountry, {
                        path: "/"
        ...
        _v: function(b) {
            ...
            var c = this._af(b),
                d = null;
            if (c) {
                var e = this.m[this._m(c)],
                    f = this.o && -1 != a.inArray(this.o.iso2, e);
                if (!f || this._w(b, c))
        ...
        _ab: function(a) {
            ...
            this._z(a.attr(b), !0), this.isMobile || this._ac(), this._ae(a.attr("data-dial-code"), !0), this.g.trigger("change"), this.g.focus()
        },
        _ac: function() {
